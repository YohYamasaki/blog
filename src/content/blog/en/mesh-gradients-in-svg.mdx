...
Update(2026-08-25): It seems that Safari has recently introduced several bugs from [this commit](https://github.com/WebKit/WebKit/commit/452bf001ddd493cec2bb64e8c2d0286a007b5738), which break the behaviour of the `feDisplacementMap`. While we investigate a workaround, please use Chromium or Firefox to run the demo.
